...
#ifndef omega_i_
#define omega_i_ 1.d0
#endif

#ifndef omega_f_
#define omeag_f_ 2.d0
#endif
...
!!cargo los parametros para el problema
  ...
  l5 = char(modulo(int(1000._pr*lambda), 100000)/10000 + 48);
...
!!calulo la energia cinetica
  ...
  open(11, file='./resultados/auval_vs_omega-lambda'//l4//l3//l2//l1//'-B'//B2//B1//'T-2.dat')
  write(11,*) '# me =', me
  write(11,*) '# V0 =', V0*eV
  write(11,*) '# B_campo =', B_campo
  write(11,*) '# lambda =', lambda
  write(11,*) '# omega_i =', omega_i, 'omega_f =', omega_f
  write(11,*) '# N_omega =', N_omega
