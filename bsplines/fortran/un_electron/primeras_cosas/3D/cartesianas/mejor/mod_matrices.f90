module matrices
contains
subroutine hamiltoniano(nb, v0, s, v, ke, h, ms)
  use precision, pr => dp
  implicit none
  integer, intent(in) :: nb
  real(pr), intent(in) :: v0
  real(pr), intent(in) :: s(nb,nb), v(nb,nb), ke(nb,nb)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
subroutine calculo_matrices(kord, l_interval, n_cuad, nk, nb, me, sigma, t, k, x, w, s, v, ke)
  use precision, pr => dp
  implicit none
  ...
  real(pr), intent(out) :: s(nb,nb), v(nb,nb), ke(nb,nb)
  !!!
