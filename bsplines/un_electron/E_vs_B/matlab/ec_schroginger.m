...
z = z(:);
V0_i = 0.0; V0_f = 0.1; % en eV
V = linspace(V0_i, V0_f, 100);
...
for V0 = V
  ...
  energias = diag(E)';
  energias = [V0, energias(1:15)];

  auval = [auval; energias];
  ...
  % save('-ascii', '-append', './resultados/auval.dat', 'energias');

end

save('-ascii', './resultados/auval.dat', 'auval');
