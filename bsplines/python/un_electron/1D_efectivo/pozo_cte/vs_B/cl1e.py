...
archivo1 = "./resultados0111/E_vs_B-v1_%6.4feV-v2_%6.4feV-az_%6.4f-bz_%6.4f.dat" % (v1, v2, az, bz)
archivo2 = "./resultados0111/z_vs_B-v1_%6.4feV-v2_%6.4feV-az_%6.4f-bz_%6.4f.dat" % (v1, v2, az, bz)
...
for bcampo in bcampo_vec:
	...
	Hz = Tz + v1*Vz2 - v2*(1 - np.exp(-0.5*(r0/l_campo)**2))*Vz1;
