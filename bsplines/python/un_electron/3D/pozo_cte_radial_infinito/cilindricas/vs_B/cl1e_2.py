...
r0_vec = np.array([7.0, 9.0, 10.0, 12.0, 15.0, 20.0])
...
for r0 in r0_vec:
	...
	archivo1 = "./res24022017/E_vs_B-v1%6.4feV-v2%6.4feV-az%6.4f-r0%6.4f-Bi%3.1f-Bf%3.1f.dat" % (v1, v2, az, r0, B_i, B_f)
	archivo2 = "./res24022017/z_vs_B-v1%6.4feV-v2%6.4feV-az%6.4f-r0%6.4f-Bi%3.1f-Bf%3.1f.dat" % (v1, v2, az, r0, B_i, B_f)
