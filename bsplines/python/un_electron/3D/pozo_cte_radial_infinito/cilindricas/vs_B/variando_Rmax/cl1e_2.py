...
r0_i	 = 7.0; ## Ancho del pozo en rho
az_i	 = 7.0;
bz_i	 = 2.5;
v1_i	 = 0.37; ## Alto de la barrera
v2_i	 = 0.108844; ## Profundidad del pozo
B_i		 = 0.0;
B_f 	 = 150.0;

# Rmax_vec = np.linspace(r0_i, 50.0, int(50.0 - r0_i)/5 + 1);
Rmax_vec = np.array([7.0, 10.0, 15.0, 20.0, 25.0, 30.0, 35.0, 40.0, 45.0, 50.0]);
bcampo_vec = np.linspace(B_i, B_f, 151);
...
for Rmax in Rmax_vec:
	...
	az		 = az_i;
	bz		 = bz_i;
	v1		 = v1_i; ## Alto de la barrera
	v2		 = v2_i; ## Profundidad del pozo

	archivo1 = "./res01032017/E_vs_B-v1%6.4feV-v2%6.4feV-az%6.4f-r0%6.4f-Rmax%6.4f-Bi%3.1f-Bf%3.1f.dat" % (v1, v2, az, r0, Rmax, B_i, B_f)
	archivo2 = "./res01032017/z_vs_B-v1%6.4feV-v2%6.4feV-az%6.4f-r0%6.4f-Rmax%6.4f-Bi%3.1f-Bf%3.1f.dat" % (v1, v2, az, r0, Rmax, B_i, B_f)
	...
	for bcampo in bcampo_vec:
		...
		z_exp = np.dot(np.transpose(auvec), np.dot(np.abs(rz_mat), auvec))
